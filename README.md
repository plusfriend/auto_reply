...
## [공지] 2019년 12월 31일 API형 스마트채팅 서비스 종료 안내

안녕하세요. 카카오톡 채널팀입니다. <br/>
2019년 12월 31일, 사전에 공지드린 대로 API형 스마트채팅 서비스가 완전 종료될 예정입니다. <br/>
API형 스마트채팅 서비스 종료 이후에는 대화형 인터페이스 챗봇을 제작할 수 있는 플랫폼인<br/>
카카오 i 오픈빌더를 통해 챗봇을 제작해 주셔야 합니다.<br/>
