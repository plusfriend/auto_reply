...
- 스마트채팅 하위 메뉴인 '챗봇' 페이지 접속 시 카카오 i 오픈빌더 플랫폼([https://i.kakao.com](https://i.kakao.com))으로 접근할 수 있으며 대화형 인터페이스의 챗봇을 제작할 수 있습니다. 카카오 i 오픈빌더에서 챗봇과 플러스친구를 연동할 경우 '채팅방 메뉴'와 'API형 스마트채팅'은 사용할 수 없습니다. 
